...
<script>
  ...
  export default {
    ...
    async asyncData({$axios, error, params}){
      try{
        const now = await $axios.get('https://api.themoviedb.org/3/movie/upcoming?api_key=88d32cefcb06d0c3a2834e4897e3896c&page='+params.page)
        return{
