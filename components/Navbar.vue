<template>
	<div>
	        ...
	        <div class="flex items-center">
	          ...
	          <div class="hidden md:block">
	            <div class="ml-10 flex items-baseline">
	              ...
	              <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm font-medium text-gray-300 focus:primary hover:primary focus:outline-none">TV Series</a>	              
	  ...
	  <div class="h-16 z-50  bottom-0 fixed md:hidden block w-full dark2">
			  ...
			  <div class="flex-1 text-center">
			  	<nuxt-link to="/" class="text-white font-semibold tracking-wider mt-1 sm:text-sm text-xs custom-white focus:primary hover:primary">
				  	<div class="flex justify-center">
				  		<svg class="h-6 w-6" stroke="#7c7c7d" fill="#7c7c7d" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	  ...
	  <div v-show="search" class="search absolute z-50 top-0 h-full w-full bg-gray-700 fixed">
